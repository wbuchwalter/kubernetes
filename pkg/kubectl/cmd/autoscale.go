...
var (
	...
	autoscaleExample = templates.Examples(`
		# Auto scale a deployment "foo", with the number of pods between 2 and 10, target CPU utilization not specified so a default autoscaling policy will be used:
